...
@section('content')
    <div
        style="max-width:1000px; margin:40px auto; background:#fff; padding:25px; border-radius:12px; box-shadow:0 8px 20px rgba(0,0,0,0.08);">
        ...
        <div
            ...
            @endphp
            <div
                style="padding: 10px 20px; border-radius: 40px;
                    ...
                    @forelse ($sales as $sale)
                        ...
                        <tr style="border-bottom: 1px solid #e5e7eb;">
                            ...
                            <td style="padding: 12px; text-align: center;">
                                <span
                                    style="background: {{ $statusColor }}; color: {{ $statusTextColor }}; padding: 4px 12px; border-radius: 20px; font-size: 13px; font-weight: 600;">
                                ...
                                <div style="display: flex; gap: 5px; justify-content: center; flex-wrap: wrap;">
                                    ...
                                    <form method="POST" action="{{ route('sales.destroy', $sale->id) }}"
                                        ...
                                        <button type="submit"
                                            ...
                                            onmouseout="this.style.background='#fee2e2'" title="Delete Invoice">
                                            🗑️ Delete
                                        </button>
                                    </form>
                                </div>

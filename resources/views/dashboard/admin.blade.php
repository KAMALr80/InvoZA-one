...
<div class="dashboard-container">
    ...
    <div class="dashboard-row">
        ...
        <div class="recent-activity-section">
            <div class="section-header">
                <div class="section-title-container">
                    <div class="section-icon-container section-icon-purple">
                        🔄
                    </div>
                    <div>
                ...
                <div class="activity-filter">
                    <select class="activity-filter-select" id="activityFilter" onchange="filterActivities(this.value)">
            ...
            <div class="activity-feed-container" id="activityFeedContainer">
                <!-- PHP Activities will be loaded here from controller -->
                @if(isset($recentActivities) && count($recentActivities) > 0)
                    @foreach($recentActivities as $activity)
                        <div class="activity-item activity-{{ $activity['color'] ?? 'blue' }}" data-type="{{ $activity['type'] ?? 'all' }}">
                            ...
                            <div class="activity-content">
                                ...
                                <div class="activity-footer">
                                    ...
                                    <span class="activity-type type-{{ $activity['type'] ?? 'system' }}">
...
<script>
    ...
    function filterActivities(type) {
        ...
        if (visibleActivities.length === 0 && !noActivitiesMsg) {
            // Create and show no activities message
            const container = document.getElementById('activityFeedContainer');
            const noActivities = document.createElement('div');
            noActivities.className = 'no-activities';
            noActivities.innerHTML = `
                <div class="no-activities-icon">🔍</div>
                <h3 class="no-activities-title">No ${type} activities</h3>
                <p class="no-activities-text">There are no ${type} activities to display.</p>
            `;
...
<style>
    ...
    /* Dashboard Row for Low Stock and Recent Activity */
    .dashboard-row {
        display: grid;
